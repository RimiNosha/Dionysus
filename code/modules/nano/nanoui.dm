...
/datum/nanoui
  ...
  */
/datum/nanoui/New(nuser, nsrc_object, nui_key, ntemplate_filename, ntitle = 0, nwidth = 0, nheight = 0, var/datum/nref = null, var/datum/nanoui/master_ui = null)
	user = nuser
...
/datum/nanoui/proc/try_update(update = 0)
 ...
 /**
  * This process proc is called by SSnanoui.
