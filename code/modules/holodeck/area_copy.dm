...
GLOBAL_LIST_INIT(duplicate_forbidden_vars,list(
	...
	"important_recursive_contents", "bodyparts", "organs", "hand_bodyparts", "overlays_standing", "hud_list",
	"actions", "AIStatus", "appearance", "managed_overlays", "computer_id", "lastKnownIP", "implants",
	"tgui_shared_states"
	))
