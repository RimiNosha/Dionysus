...
/datum/design/handdrill
	...
	materials = list(/datum/material/steel = 3500, /datum/material/silver = 1500, /datum/material/titanium = 2500)
...
/datum/design/jawsoflife
	...
	build_type = FABRICATOR
	materials = list(/datum/material/steel = 4500, /datum/material/silver = 2500, /datum/material/titanium = 3500)
	category = list(DCAT_BASIC_TOOL)
	mapload_design_flags = DESIGN_FAB_ENGINEERING
...
/datum/design/exwelder
	...
	id = "exwelder"
	build_type = FABRICATOR
	materials = list(/datum/material/steel = 1000, /datum/material/glass = 500, /datum/material/plasma = 1500, /datum/material/uranium = 200)
