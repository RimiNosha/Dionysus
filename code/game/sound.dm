...
/proc/get_sfx(soundin)
	if(istext(soundin))
		switch(soundin)
			...
			if (SFX_PUNCH)
				soundin = pick(
					'sound/weapons/attack/punch.ogg',
					'sound/weapons/attack/punch_2.ogg',
					'sound/weapons/attack/punch_3.ogg',
					'sound/weapons/attack/punch_4.ogg',
				)
			if (SFX_CLOWN_STEP)
				soundin = pick(
			...
			if(SFX_PAINT)
				soundin= pick(
					'sound/effects/paint_1.ogg',
					'sound/effects/paint_2.ogg',
					'sound/effects/paint_3.ogg',
				)
			...
			if(SFX_KEYBOARD)
				soundin = pick(
					'goon/sounds/keyboard1.ogg',
					'goon/sounds/keyboard2.ogg',
					'goon/sounds/keyboard3.ogg',
				)
			if(SFX_GLASS_CRACK)
				soundin = pick(
