...
/datum/crewmonitor
	...
	var/list/jobs = list(
		...
		// 00: Captain
		JOB_PORT_AUTHORITY = 00,
		// 10-19: Security
		JOB_PORT_MARSHAL = 10,
		JOB_BRIG_LIEUTENANT = 11,
		JOB_SECURITY_LIASON = 12,
		JOB_SECURITY_LIASON_MEDICAE = 13,
		JOB_SECURITY_LIASON_ENGINEERING = 14,
		JOB_SECURITY_OFFICER_SCIENCE = 15,
		JOB_SECURITY_LIASON_REQUISITIONS = 16,
		JOB_COMPLIANCE_AUDITOR = 17,
		// 20-29: Medbay
		JOB_DIRECTOR_OF_MEDICAE_SERVICES = 20,
		JOB_PHARMACOLOGIST = 21,
		JOB_VIROLOGIST = 22,
		JOB_MEDICAE_TECHNICIAN = 23,
		JOB_PARAMEDIC = 24,
		// 40-49: Engineering
		...
		JOB_DECKHAND = 52,
		// 60+: Civilian/other
		JOB_DIRECTOR_OF_PORT_SERVICES = 60,
		JOB_LOUNGE_STEWARD = 61,
		JOB_CULINARY_VENDOR = 62,
		JOB_BOTANIST = 63,
		JOB_ARCHIVIST = 64,
		JOB_CHAPLAIN = 65,
		JOB_CLOWN = 66,
		JOB_JANITOR = 68,
		JOB_CIVIL_REPRESENTATIVE = 69,
		JOB_PSYCHOLOGIST = 71,
		// 200-229: Centcom
