...
export const SolarControl = (props) => {
  ...
  const { generated, generated_ratio, azimuth_current, azimuth_rate, max_rotation_rate, tracking_state, connected_panels, connected_tracker } = data;
  return (
        ...
        <Section title="Controls">
          <LabeledList>
            <LabeledList.Item label="Tracking">
              ...
              <Button icon="clock-o" content="Timed" selected={tracking_state === 1} onClick={() => act('tracking', { mode: 1 })} />
              <Button icon="sync" content="Auto" selected={tracking_state === 2} disabled={!connected_tracker} onClick={() => act('tracking', { mode: 2 })} />
            </LabeledList.Item>
