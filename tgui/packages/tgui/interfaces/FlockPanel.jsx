...
import { Box, Button, Dropdown, Icon, Section, Stack, Tabs } from '../components';
            ...
            <Stack>
              ...
              <Stack.Item grow={1}>
                <Section height="100%">
                  ...
                  {structure.compute < 0 && 'Compute cost: ' + structure.compute}
                </Section>
              </Stack.Item>
              {/* buttons */}
              <Stack.Item>
  ...
  return (
    <Window theme="flock" title={'Flockmind ' + vitals.name} width={600} height={450}>
      <Window.Content scrollable>
        ...
        {category === 'drones' && (
          <Box>
            <Dropdown options={['name', 'health', 'resources', 'area']} selected="resources" onSelected={(value) => setSortBy(value)} />
