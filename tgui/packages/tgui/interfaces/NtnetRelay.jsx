...
export const NtnetRelay = (props) => {
  ...
  return (
    <Window title="NtNet Quantum Relay" width={400} height={300}>
      <Window.Content>
        <Section title="Network Buffer" buttons={<Button icon="power-off" selected={enabled} content={enabled ? 'ENABLED' : 'DISABLED'} onClick={() => act('toggle')} />}>
          {!dos_crashed ? (
            ...
            <Box fontFamily="monospace">
              ...
              <Box>
                This system is suffering temporary outage due to overflow of traffic buffers. Until buffered traffic is processed, all further requests will be dropped. Frequent
                occurences of this error may indicate insufficient hardware capacity of your network. Please contact your network planning department for instructions on how to
                resolve this issue.
              </Box>
