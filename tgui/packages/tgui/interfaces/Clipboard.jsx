...
export const Clipboard = (props) => {
  ...
  const { pen, integrated_pen, top_paper, top_paper_ref, paper, paper_ref } = data;
  return (
      ...
      <Window.Content backgroundColor="#704D25" scrollable>
        ...
        {paper.map((paper_item, index) => (
          <Flex key={paper_ref[index]} color="black" backgroundColor="white" style={{ padding: '2px 2px 0 2px' }} mb={0.5}>
            <Flex.Item>
              <Button icon="chevron-up" color="transparent" iconColor="black" onClick={() => act('move_top_paper', { ref: paper_ref[index] })} />
            </Flex.Item>
            <Flex.Item align="center" grow={1}>
