...
export const MechBayPowerConsole = (props) => {
  ...
  return (
    <Window width={400} height={200}>
      <Window.Content>
        <Section title="Mech status" textAlign="center" buttons={<Button icon="sync" content="Sync" onClick={() => act('reconnect')} />}>
          <LabeledList>
            <LabeledList.Item label="Integrity">
              {(!recharge_port && <NoticeBox>No power port detected. Please re-sync.</NoticeBox>) || (!mech && <NoticeBox>No mech detected.</NoticeBox>) || (
                <ProgressBar
