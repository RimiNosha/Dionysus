...
export const RoundGauge = (props) => {
  const { value, minValue = 1, maxValue = 1, ranges, alertAfter, alertBefore, format, size = 1, className, style, ...rest } = props;
            ...
            {Object.keys(scaledRanges).map((x, i) => {
              ...
              return (
                <circle
                  ...
                  key={i}
                  style={{
                    strokeDashoffset: Math.max((2.0 - (col_ranges[1] - col_ranges[0])) * Math.PI * 50, 0),
                  }}
